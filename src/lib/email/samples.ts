...
export const SAMPLE_PARAMS = {
  ...
  passwordResetLink: { nickname: 'aysel', url: 'https://campusnotehub.com/reset-password#token=example', minutes: 30 },
  ...
  emailVerification: { nickname: 'aysel', url: 'https://campusnotehub.com/confirm-email#token=example' },
  accountSuspended: {
    nickname: 'aysel',
    level: 'suspended',

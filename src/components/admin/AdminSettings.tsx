    ...
    <>
      ...
      <div className="grid max-w-2xl gap-4">
        ...
        <section className="card border-danger/25 p-4">
          ...
          {/* A plain <a>, not <Link>: sign-out must be a full page load so no
              signed-in client state survives it, and it is never prefetched.
              See MenuItem's reloadDocument in ui/Menu.tsx. */}
          <a href="/logout" className="btn-danger mt-3 px-3 py-1.5 text-sm">
